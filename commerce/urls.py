...
from .views import (
    ...
    OrderViewSet,
    OzonCitiesView,
    OzonEligibleOrdersView,
    OzonParcelView,
    OzonSettingsView,
    OzonTrackingSyncView,
    OzonTrackingView,
...
urlpatterns = [
    ...
    path("settings/design/", HomeDesignSettingsView.as_view()),
    ...
    path("ozon/settings/", OzonSettingsView.as_view()),
    path("ozon/cities/", OzonCitiesView.as_view()),
    path("ozon/eligible-orders/", OzonEligibleOrdersView.as_view()),
    path("ozon/parcels/", OzonParcelView.as_view()),
    path("ozon/tracking/", OzonTrackingView.as_view()),
    path("ozon/tracking/sync/", OzonTrackingSyncView.as_view()),
